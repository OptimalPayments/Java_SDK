...
package com.optimalpayments.directdebit;

import java.io.IOException;

import java.util.HashMap;
import com.optimalpayments.OptimalApiClient;
import com.optimalpayments.cardpayments.Filter;
...
import com.optimalpayments.directdebit.impl.PurchasesPagerator;
import com.optimalpayments.directdebit.impl.StandaloneCreditsPagerator;
...
public class DirectDebitService {
     ...
     * @throws OptimalException the optimal exception
     */
    public final Purchases submitPurchase(Purchases purchases) throws IOException, OptimalException {
        final Request request = Request.builder()
    ...
    public final Purchases cancelPurchase(Purchases purchases) throws IOException, OptimalException {
        	final Request request = Request.builder()
     ...
     * @throws OptimalException the optimal exception
     */
    public final Purchases getPurchase(Purchases purchases) throws IOException, OptimalException 
    {
    	final Request request = Request.builder()
                .uri(prepareUri(ACCOUNTS+client.getAccount()+PURCHASE_PATH+purchases.getId()))
                .method(Request.RequestType.GET)
     ...
     * @throws OptimalException the optimal exception
     */
    public final StandaloneCredits submitStandaloneCredit(StandaloneCredits standalonecredits) throws IOException, OptimalException {
        final Request request = Request.builder()
    ...
    public final StandaloneCredits cancelStandaloneCredit(StandaloneCredits standalonecredits) throws IOException, OptimalException {
        	final Request request = Request.builder()
     ...
     * @throws OptimalException the optimal exception
     */
    public final StandaloneCredits getStandaloneCredit(StandaloneCredits standalonecredits) throws IOException, OptimalException 
    {
    	final Request request = Request.builder()
                .uri(prepareUri(ACCOUNTS+client.getAccount()+CREDIT_REQUEST_PATH+standalonecredits.getId()))
                .method(Request.RequestType.GET)
     ...
     * @throws OptimalException the optimal exception
     */
    private String prepareUri(String path) throws OptimalException {
